...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3488052435ltr&server=1">
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"6e4d297b5a44424f515456273243294b",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"36000",session_gc_maxlifetime:"36000",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.3",auth_type:"cookie",user:"root"});
...
<body>
    <div id="pma_navigation" data-config-navigation-width="222">
    ...
    <div id="pma_navigation_content">
      <div id="pma_navigation_header">
        ...
        <div id="navipanellinks">
          ...
          <a href="./url.php?url=https%3A%2F%2Fdev.mysql.com%2Fdoc%2Frefman%2F5.7%2Fen%2Findex.html" title="MySQL Documentation" target="_blank" rel="noopener noreferrer"><img src="themes/dot.gif" title="MySQL Documentation" alt="MySQL Documentation" class="icon ic_b_sqlhelp"></a>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_menu_submenu&table=anandadhara">`laravel_menu_submenu`.`anandadhara`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_menu_submenu&table=mgnregs">`laravel_menu_submenu`.`mgnregs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_menu_submenu&table=kishan_mandi">`laravel_menu_submenu`.`kishan_mandi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_menu_submenu&table=user">`laravel_menu_submenu`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_menu_submenu&table=kishan_credit_card">`laravel_menu_submenu`.`kishan_credit_card`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_menu_submenu&table=user_permission">`laravel_menu_submenu`.`user_permission`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_menu_submenu&table=submenu">`laravel_menu_submenu`.`submenu`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_menu_submenu&table=menu">`laravel_menu_submenu`.`menu`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6e4d297b5a44424f515456273243294b">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="222"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
